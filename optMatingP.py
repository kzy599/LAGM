...
def load_input_data(file_path):
    ...
    return individual_ids, ebv_vector, kinship_matrix, female_ids, male_ids, geno_matrix,gen,He
...
def main():
    ...
    parser.add_argument('--output_pairs', type=str, default='breeding_pairs2.json', help='Path to save the breeding pairs JSON file.')
    args = parser.parse_args()

    # Load input data
    individual_ids, ebv_vector, kinship_matrix, female_ids, male_ids, geno_matrix,gen,He = load_input_data(args.input_file)
    if He is None:
