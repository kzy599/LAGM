...
run_ocs_aqua = function(candidate,targetDegree,minInb,nCrosses,nProgenyPerCross,nDam,nSire,Fix_fmRatio=TRUE,targetMinInbreedingPct=NULL,coancestryWeight=NULL,inbreedingWeight=NULL,coancestryWeightBelow=NULL,inbreedingWeightBelow=NULL){
    if(Fix_fmRatio){
    pop <- ocs(
        pop = candidate,
        nCrosses = nCrosses,
        ...
        targetMinInbreedingPct = targetMinInbreedingPct,
        coancestryWeight = coancestryWeight,
        inbreedingWeight = inbreedingWeight,
        coancestryWeightBelow = coancestryWeightBelow,
        inbreedingWeightBelow = inbreedingWeightBelow
  )
    }else{
    pop <- ocs(
        pop = candidate,
